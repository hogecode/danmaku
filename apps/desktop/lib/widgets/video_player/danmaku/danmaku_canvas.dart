...
import 'package:desktop/widgets/video_player/danmaku/danmaku_item_widget.dart';
import 'package:desktop/widgets/video_player/danmaku/danmaku_lane_manager.dart';
...
class _DanmakuCanvasState extends ConsumerState<DanmakuCanvas> {
  ...
  Widget build(BuildContext context) {
    ...
    _updateDanmaku(widget.danmakuList);
