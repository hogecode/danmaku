...
class RefreshTokenResponseDto {
  ...
  @override
  String toString() => 'RefreshTokenResponseDto[accessToken=$accessToken, expiresIn=$expiresIn]';
  ...
  static RefreshTokenResponseDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'access_token'), 'Required key "RefreshTokenResponseDto[access_token]" is missing from JSON.');
        assert(json[r'access_token'] != null, 'Required key "RefreshTokenResponseDto[access_token]" has a null value in JSON.');
        assert(json.containsKey(r'expires_in'), 'Required key "RefreshTokenResponseDto[expires_in]" is missing from JSON.');
        assert(json[r'expires_in'] != null, 'Required key "RefreshTokenResponseDto[expires_in]" has a null value in JSON.');
        return true;
      }());
